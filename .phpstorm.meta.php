...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'nativekit.show_environment_indicator' => 'boolean',
            ...
            'filesystems.links./home/jefferson/devilbox/data/www/nativekit/public/storage' => 'string',
            ...
            'filament-impersonate.guard' => 'string',
            'filament-impersonate.redirect_to' => 'string',
            'filament-impersonate.leave_middleware' => 'string',
            'filament-impersonate.banner.render_hook' => 'string',
            'filament-impersonate.banner.style' => 'string',
            'filament-impersonate.banner.fixed' => 'boolean',
            'filament-impersonate.banner.position' => 'string',
            'filament-impersonate.banner.styles.light.text' => 'string',
            'filament-impersonate.banner.styles.light.background' => 'string',
            'filament-impersonate.banner.styles.light.border' => 'string',
            'filament-impersonate.banner.styles.dark.text' => 'string',
            'filament-impersonate.banner.styles.dark.background' => 'string',
            'filament-impersonate.banner.styles.dark.border' => 'string',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','nativekit.theme_mode','nativekit.show_environment_indicator',
'nativekit.guest_panel_enabled','nativekit.admin_panel_enabled','nativekit.app_panel_enabled','nativekit.favicon.enabled','nativekit.favicon.manifest.name',
'nativekit.favicon.logo','nativekit.favicon.favicon','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/jefferson/devilbox/data/www/nativekit/public/storage',
...
'filament.cache_path','filament.livewire_loading_delay','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using',
...
'livewire.pagination_theme','filament-impersonate.guard','filament-impersonate.redirect_to','filament-impersonate.leave_middleware','filament-impersonate.banner.render_hook',
'filament-impersonate.banner.style','filament-impersonate.banner.fixed','filament-impersonate.banner.position','filament-impersonate.banner.styles.light.text','filament-impersonate.banner.styles.light.background',
'filament-impersonate.banner.styles.light.border','filament-impersonate.banner.styles.dark.text','filament-impersonate.banner.styles.dark.background','filament-impersonate.banner.styles.dark.border','ide-helper.filename',
...
'filament.app.auth.logout','filament.app.auth.profile','filament.app.pages.dashboard','filament.public.auth.logout','filament.public.pages.dashboard',
'livewire.update','livewire.upload-file','livewire.preview-file',
'filament-impersonate.leave','storage.local',);
        registerArgumentsSet('views',
'components.favicon','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action','filament-actions::button-group',
...
'filament-actions::select-action','filament-environment-indicator::badge','filament-forms::component-container','filament-forms::components.actions','filament-forms::components.actions.action-container',
...
'filament-forms::components.toggle-buttons.grouped','filament-forms::components.toggle-buttons.index','filament-forms::components.wizard','filament-forms::components.wizard.step','filament-impersonate::components.banner',
...
'filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-tables::columns.checkbox-column','filament-tables::columns.color-column','filament-tables::columns.icon-column',
...
'filament::components.tabs.index','filament::components.tabs.item','impersonate::components.banner','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.uuid','validation.custom.attribute-name.rule-name','pt_BR.0','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading',
...
'filament-tables::table.sorting.fields.column.label','filament-tables::table.sorting.fields.direction.label','filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','filament-impersonate::action.label',
'filament-impersonate::banner.impersonating','filament-impersonate::banner.leave',);
